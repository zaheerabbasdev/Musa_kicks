...
import { faShoePrints, faArrowRight } from "@fortawesome/free-solid-svg-icons";
    ...
    <div className="min-h-[70vh] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <p className="text-text-muted text-sm sm:text-base leading-relaxed mb-8">
          The pair or page you're searching for might be out of stock, moved, or doesn't exist.
        </p>
